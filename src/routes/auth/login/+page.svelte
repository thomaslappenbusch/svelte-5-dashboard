...
<div class="w-screen h-screen bg-ui-bg flex items-center justify-center relative">
	...
	<div class="px-10 flex flex-col items-start justify-start w-[450px]">
		...
		<form class="w-full" method="POST" action="?/login" use:enhance={handleSubmit}>
		...
		<button
			class="py-2 flex items-center justify-center border border-ui-br w-full rounded-md text-sm hover:bg-ui-bg-2 transition focus:outline-none focus:border focus:border-ui-tx-3"
		>
		...
		<button
			class="py-2 flex items-center justify-center border mt-2 border-ui-br w-full rounded-md text-sm hover:bg-ui-bg-2 transition focus:outline-none focus:border focus:border-ui-tx-3"
		>
